...
C  The padding size must be even:
     ...
     &  P,MW,ZBISPREF)
      ...
      DEALLOCATE(DBETA)
      ALLOCATE(DPDSOBS(P,P))
      ALLOCATE(DPDSREF(P,P))
      CALL GETPDS(FILEOBS,FPOBS,LPOBS,DROBS,P,FTMETHOD,DPDSOBS)
      CALL GETPDS(FILEREF,FPREF,LPREF,DRREF,P,FTMETHOD,DPDSREF)
      ALLOCATE(DRHO(P,P))
      DRHO=DPDSOBS/DPDSREF
      ALLOCATE(ZIN(P,P))
      ALLOCATE(ZOUT(P,P))
